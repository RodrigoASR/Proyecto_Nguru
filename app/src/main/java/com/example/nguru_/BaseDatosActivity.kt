    ...
    private fun setup(){
        ...
        save.setOnClickListener{
            ...
            if (partido.text.isNotEmpty()) {
                ...
                db.collection("constituyentes").document(id.text.toString()).set(
                    hashMapOf("id" to id.text.toString(),
        ...
        eliminar.setOnClickListener{
            if (id.text.isNotEmpty()) {
            db.collection("constituyentes").document(id.text.toString()).delete()
                showGood()
            }else{
                showError()
                }
