...
class ConcejalesActivity : AppCompatActivity() {

    private val db = FirebaseFirestore.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_concejales)
    ...
    private fun setup(){
        ...
        title ="Base de datos Consejales"
        ...
        save.setOnClickListener{
            ...
            if (partido.text.isNotEmpty()) {
                ...
                db.collection("consejales").document(id.text.toString()).set(
                    hashMapOf(
        ...
        eliminar.setOnClickListener{
            if (id.text.isNotEmpty()) {
                db.collection("consejales").document(id.text.toString()).delete()
                showGood()
            }else{
                showError()
            }
