...
class GobernadorActivity : AppCompatActivity() {

    private val db = FirebaseFirestore.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_gobernador)
    ...
    private fun setup(){
        ...
        save.setOnClickListener{
            ...
            if (partido.text.isNotEmpty()) {
                ...
                db.collection("gobernadores").document(id.text.toString()).set(
                    hashMapOf(
        ...
        eliminar.setOnClickListener{
            if (id.text.isNotEmpty()) {
                db.collection("gobernadores").document(id.text.toString()).delete()
                showGood()
            }else{
                showError()
            }
