...
class pregunta2Activity : AppCompatActivity() {
    ...
    private fun setup(){
        ...
        var email = findViewById<TextView>(R.id.emailTextView2)
        val bundle = intent.extras
        var email2 = bundle?.getString("email")
        email.setText(email2)

        val bundle1 = intent.extras
        var resultado1 = bundle1?.getString("resultado1")

        val bundle2 = intent.extras
        var resultpag1 = bundle2 ?.getInt("valorPag1")
        ...
        siguiente.setOnClickListener{
            ...
            if (resp1 != item && resp2 != item && resp3 != item && resp4 != item
                ...
                var sigue3 = Intent(this, ResultadoEncuestaUsers::class.java)
