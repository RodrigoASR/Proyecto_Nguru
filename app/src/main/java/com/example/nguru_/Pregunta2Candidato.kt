...
class Pregunta2Candidato : AppCompatActivity() {

    private val db = FirebaseFirestore.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_pregunta2_candidato)

        setup()
    }

    private fun setup(){
        val bundle6 = intent.extras
        var resultado1 = bundle6?.getString("resultado1")

        val bundle7 = intent.extras
        var resultpag1 = bundle7 ?.getInt("valorPag1")
        ...
        val respuesta1 = findViewById<Spinner>(R.id.alternativasSpinner11)
        val respuesta2 = findViewById<Spinner>(R.id.alternativasSpinner12)
        val respuesta3 = findViewById<Spinner>(R.id.alternativasSpinner13)
        val respuesta4 = findViewById<Spinner>(R.id.alternativasSpinner14)
        val respuesta5 = findViewById<Spinner>(R.id.alternativasSpinner15)
        val respuesta6 = findViewById<Spinner>(R.id.alternativasSpinner16)
        val respuesta7 = findViewById<Spinner>(R.id.alternativasSpinner17)
        val respuesta8 = findViewById<Spinner>(R.id.alternativasSpinner18)
        val respuesta9 = findViewById<Spinner>(R.id.alternativasSpinner19)
        val respuesta10 = findViewById<Spinner>(R.id.alternativasSpinner20)

        val siguiente = findViewById<Button>(R.id.siguiente2Button)
        ...
        siguiente.setOnClickListener{
            ...
            if (resp1 != item && resp2 != item && resp3 != item && resp4 != item
                ...
                when(eleccion){
                    ...
                    1->db.collection("constituyentes").document(id.text.toString()).update(
                        hashMapOf("respuesta11" to valor1, "respuesta12" to valor2, "respuesta13" to valor3, "respuesta14" to valor4, "respuesta15" to valor5
                            , "respuesta16" to valor6, "respuesta17" to valor7, "respuesta18" to valor8, "respuesta19" to valor9, "respuesta20" to valor10,
                            "economico" to total1) as Map<String, Any>)

                    2->db.collection("alcaldes").document(id.text.toString()).update(
                        hashMapOf("respuesta11" to valor1, "respuesta12" to valor2, "respuesta13" to valor3, "respuesta14" to valor4, "respuesta15" to valor5
                            , "respuesta16" to valor6, "respuesta17" to valor7, "respuesta18" to valor8, "respuesta19" to valor9, "respuesta20" to valor10,
                            "economico" to total1) as Map<String, Any>)

                    3->db.collection("consejales").document(id.text.toString()).update(
                        hashMapOf("respuesta11" to valor1, "respuesta12" to valor2, "respuesta13" to valor3, "respuesta14" to valor4, "respuesta15" to valor5
                            , "respuesta16" to valor6, "respuesta17" to valor7, "respuesta18" to valor8, "respuesta19" to valor9, "respuesta20" to valor10,
                            "economico" to total1) as Map<String, Any>)

                    4->db.collection("gobernadores").document(id.text.toString()).update(
                        hashMapOf("respuesta11" to valor1, "respuesta12" to valor2, "respuesta13" to valor3, "respuesta14" to valor4, "respuesta15" to valor5
                            , "respuesta16" to valor6, "respuesta17" to valor7, "respuesta18" to valor8, "respuesta19" to valor9, "respuesta20" to valor10,
                            "economico" to total1) as Map<String, Any>)

                    5->db.collection("presidentes").document(id.text.toString()).update(
                        hashMapOf("respuesta11" to valor1, "respuesta12" to valor2, "respuesta13" to valor3, "respuesta14" to valor4, "respuesta15" to valor5
                            , "respuesta16" to valor6, "respuesta17" to valor7, "respuesta18" to valor8, "respuesta19" to valor9, "respuesta20" to valor10,
                            "economico" to total1) as Map<String, Any>)
                }
                ...
                var sigue3 = Intent(this, ResultadoEncuestaCandidatos::class.java)
                sigue3.putExtra("id", id.text.toString())
                sigue3.putExtra("datos", eleccion)
                sigue3.putExtra("social",resultado1)
                sigue3.putExtra("economico", total1.toString())
                sigue3.putExtra("resulpag1", resultpag1)
                sigue3.putExtra("resulpag2", total1)
